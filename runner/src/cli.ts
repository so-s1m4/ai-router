...
export type Job={jobId:string;accountId:string;provider:ProviderId;sessionId:string;projectId?:string;prompt:string;model:string;mode:'chat'|'task'};
export type Event={type:'status'|'delta'|'tool'|'usage';text?:string;message?:string;data?:Record<string,unknown>};
export type AccountModel={id:string;label:string};
