...
export type Job={jobId:string;accountId:string;provider:ProviderId;sessionId:string;projectId?:string;prompt:string;model:string;reasoning?:string;mode:'chat'|'task'};
